  ...
  return (
    <div className="bg-gradient-to-br from-[#0f172a] to-[#1e293b] py-16">
      <div className="max-w-6xl mx-auto px-4 text-center">
        <h2 className="text-sm font-bold text-[#3b82f6] mb-3 uppercase tracking-wide">
          Check Our Steps
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, index) => (
            ...
            >
              <div className="mb-3">
                <span className="bg-[#f97316] text-[#0f172a] text-xs font-bold px-4 py-1 rounded-full">
                  {step.step}
                </span>
              </div>
        ...
        <div className="mt-12 flex justify-center space-x-4">
          <button className="bg-gradient-to-r from-[#f97316] to-[#fb923c] text-white px-6 py-3 rounded-full text-base font-semibold shadow-md hover:shadow-lg hover:scale-105 transition">
            Get Started
          </button>
          <button className="bg-gradient-to-r from-[#3b82f6] to-[#60a5fa] text-white px-6 py-3 rounded-full text-base font-semibold shadow-md hover:shadow-lg hover:scale-105 transition">
            Learn More
          </button>
        </div>
      </div>
